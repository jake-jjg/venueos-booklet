  ...
  <div class="w-full flex flex-col gap-4">
    ...
    <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      ...
      <UCard variant="subtle">
        <template #header>
          <div class="flex items-center justify-between">
            <span class="text-sm font-semibold text-muted">Page Views</span>
        ...
        <div class="flex flex-col gap-2">
          ...
          >
            ...
            />
            <span
              >{{ Math.abs(analyticsData.pageViewsChange) }}% vs last
              period</span
            >
          </div>
        </div>
      ...
      <UCard variant="subtle">
        <template #header>
          <div class="flex items-center justify-between">
            <span class="text-sm font-semibold text-muted">CTA Clicks</span>
            <UIcon
        ...
        <div class="flex flex-col gap-2">
          ...
          >
            ...
            />
            <span
              >{{ Math.abs(analyticsData.ctaClicksChange) }}% vs last
              period</span
            >
          </div>
        </div>
      ...
      <UCard variant="subtle">
        <template #header>
          <div class="flex items-center justify-between">
            ...
            >
            <UIcon name="i-lucide-target" class="size-4 text-green-600" />
          </div>
        </template>
        <div class="flex flex-col gap-2">
          <p class="text-3xl font-headline">
          ...
          >
            <UIcon
              :name="getChangeIcon(analyticsData.conversionRateChange)"
              class="size-4"
            />
            <span
              >{{ Math.abs(analyticsData.conversionRateChange) }}% vs last
              period</span
            >
          </div>
        </div>
      ...
      <UCard variant="subtle">
        <template #header>
          <div class="flex items-center justify-between">
            ...
            >
            <UIcon name="i-lucide-clock" class="size-4 text-purple-600" />
          </div>
        </template>
        <div class="flex flex-col gap-2">
          <p class="text-3xl font-headline">
          ...
          >
            <UIcon
              :name="getChangeIcon(analyticsData.sessionDurationChange)"
              class="size-4"
            />
            <span
              >{{ Math.abs(analyticsData.sessionDurationChange) }}% vs last
              period</span
            >
          </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 my-4">
      ...
      <div class="lg:col-span-2">
        <UCard variant="subtle">
          ...
          <div class="h-72 flex items-center justify-center text-muted">
            <p>Chart visualization would go here (requires chart library)</p>
          </div>
        </UCard>
      </div>
      ...
      <div>
        <UCard variant="subtle">
          ...
          <div class="h-72 flex items-center justify-center text-muted">
            <p>Donut chart would go here (requires chart library)</p>
          </div>
        </UCard>
      </div>
    </div>
    ...
    <div class="mt-4">
      <UCard variant="subtle">
        ...
        <UTable
          :rows="[
            { page: 'Home', views: 450, clicks: 120, rate: '26.7%' },
            { page: 'Services', views: 380, clicks: 95, rate: '25.0%' },
            { page: 'Gallery', views: 290, clicks: 150, rate: '51.7%' },
            { page: 'Contact', views: 114, clicks: 91, rate: '79.8%' },
          ]"
          :columns="[
