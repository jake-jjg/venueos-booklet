      ...
      <UCard variant="subtle" v-for="picker in pickers" :key="picker.key">
        <template #header>
          <div class="flex items-center gap-2">
            ...
            <span class="font-semibold text-sm">{{ picker.label }}</span>
          </div>
        </template>
        ...
        <div class="flex flex-col gap-3">
          ...
          <input
            :ref="
              (el) => (pickerRefs[picker.key] = el as HTMLInputElement | null)
            "
            type="text"
            data-coloris
            ...
            @input="
              (e) =>
                onColorInput(picker.key, (e.target as HTMLInputElement).value)
            "
          />
      ...
      >
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <button
            ...
            :style="{ borderColor: draft.primary, color: draft.primary }"
          >
            Outline
          </button>
        </div>
